...
public class AcquiaContextDbConnectorIntegrationTest extends ESBIntegrationTest {
    ...
    public void getAllSegmentsNegativeCase() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "AcquiaContextDb_getAllSegmentsNegativeCase.txt";
        String methodName = "AcquiaContextDb_getAllSegments";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, AcquiaContextDbConnectorProperties.getProperty("secretKey"), AcquiaContextDbConnectorProperties.getProperty("accessKey"), AcquiaContextDbConnectorProperties.getProperty("apiUri"),AcquiaContextDbConnectorProperties.getProperty("invalidAccountId"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
    ...
    public void exportVisitorData() throws Exception {
        ...
        try {
           ...
           // Assert.assertTrue(jsonObject.has("id")&&jsonObject.has("location")&&jsonObject.has("statusURL"));
           // String statusId=jsonObject.getString("id");
            //AcquiaContextDbConnectorProperties.put("statusId",statusId);
            log.info("response:" + responseHeader);
    ...
    public void exportVisitorDataNegativeCase() throws Exception {
        ...
        String methodName = "AcquiaContextDb_exportVisitorData";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, AcquiaContextDbConnectorProperties.getProperty("secretKey"), AcquiaContextDbConnectorProperties.getProperty("accessKey"),AcquiaContextDbConnectorProperties.getProperty("apiUri"), AcquiaContextDbConnectorProperties.getProperty("invalidAccountId"), AcquiaContextDbConnectorProperties.getProperty("dataExport"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void createEventNegativeCase() throws Exception {
        ...
        String methodName = "AcquiaContextDb_createEvent";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, AcquiaContextDbConnectorProperties.getProperty("secretKey"), AcquiaContextDbConnectorProperties.getProperty("accessKey"), AcquiaContextDbConnectorProperties.getProperty("apiUri"),AcquiaContextDbConnectorProperties.getProperty("invalidAccountId"),AcquiaContextDbConnectorProperties.getProperty("eventName"), AcquiaContextDbConnectorProperties.getProperty("type"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
    ...
    /**
     *
     * Positive test case for deleteEvent method.
     */
    @Test(enabled=true,groups = {"wso2.esb"}, description = "AcquiaContextDb {deleteEvent} ")
    public void deleteEvent() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "AcquiaContextDb_deleteEvent.txt";
        String methodName = "AcquiaContextDb_deleteEvent";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
    ...
    /**
     * Negative test case for deleteEvent method with negative parameters.
     */
    ...
    public void deleteEventNegativeCaseNegativeCase() throws Exception {
        ...
        String methodName = "AcquiaContextDb_deleteEvent";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, AcquiaContextDbConnectorProperties.getProperty("secretKey"), AcquiaContextDbConnectorProperties.getProperty("accessKey"),AcquiaContextDbConnectorProperties.getProperty("apiUri"), AcquiaContextDbConnectorProperties.getProperty("invalidAccountId"),AcquiaContextDbConnectorProperties.getProperty("eventName"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void getExportVisitorDataStatusNegativeCase() throws Exception {
        ...
        String methodName = "AcquiaContextDb_getExportVisitorDataStatus";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, AcquiaContextDbConnectorProperties.getProperty("secretKey"), AcquiaContextDbConnectorProperties.getProperty("accessKey"),AcquiaContextDbConnectorProperties.getProperty("apiUri"), AcquiaContextDbConnectorProperties.getProperty("invalidAccountId"),AcquiaContextDbConnectorProperties.getProperty("invalidStatusId"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
